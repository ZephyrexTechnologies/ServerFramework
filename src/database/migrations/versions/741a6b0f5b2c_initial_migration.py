...
def upgrade() -> None:
    ...
    sa.Column('email', sa.String(), nullable=True, comment="User's email address used for login and communications"),
    sa.Column('username', sa.String(), nullable=True, comment='Optional username that can be used for login instead of email'),
    sa.Column('display_name', sa.String(), nullable=True, comment="User's preferred display name shown in the interface"),
    sa.Column('first_name', sa.String(), nullable=True, comment="User's first/given name"),
    sa.Column('last_name', sa.String(), nullable=True, comment="User's last/family name"),
    sa.Column('mfa_count', sa.Integer(), nullable=True, comment='Number of MFA methods required for authentication'),
    sa.Column('active', sa.Boolean(), nullable=True, comment='Whether this user account is active and allowed to log in'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('jwt_issued_at', sa.DateTime(), nullable=False, comment='When the JWT was issued'),
    sa.Column('refresh_token_hash', sa.String(), nullable=True, comment='Hash of refresh token if refresh mechanism is enabled'),
    sa.Column('device_type', sa.String(), nullable=True, comment='Type of device used for authentication (mobile, desktop, etc.)'),
    sa.Column('device_name', sa.String(), nullable=True, comment='Name of the device if provided'),
    sa.Column('browser', sa.String(), nullable=True, comment='Browser information from user agent'),
    sa.Column('is_active', sa.Boolean(), nullable=True, comment='Whether this session is currently active'),
    sa.Column('last_activity', sa.DateTime(), nullable=False, comment='Timestamp of last activity in this session'),
    sa.Column('expires_at', sa.DateTime(), nullable=False, comment='When this session expires'),
    sa.Column('revoked', sa.Boolean(), nullable=True, comment='Whether this session has been explicitly revoked'),
    sa.Column('trust_score', sa.Integer(), nullable=True, comment='Trust level of this session (0-100)'),
    sa.Column('requires_verification', sa.Boolean(), nullable=True, comment='Whether additional verification is required'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_authsession_users_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('ip_address', sa.String(), nullable=True, comment='IP address from which the failed login attempt originated'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_failedloginattempt_users_id'),
    sa.PrimaryKeyConstraint('id'),
    comment='Records of failed login attempts for security monitoring and lockout enforcement'
    )
    op.create_table('provider_extensions',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('extension_id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['extension_id'], ['extensions.id'], name='fk_providerextension_extensions_id'),
    sa.ForeignKeyConstraint(['provider_id'], ['providers.id'], name='fk_providerextension_providers_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('provider_id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['provider_id'], ['providers.id'], name='fk_providerinstance_providers_id'),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], name='fk_providerinstance_teams_id'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_providerinstance_users_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('name', sa.String(), nullable=False, comment='Unique role identifier/code'),
    sa.Column('friendly_name', sa.String(), nullable=True, comment='Human-readable display name for the role'),
    sa.Column('mfa_count', sa.Integer(), nullable=True, comment='Minimum number of MFA verifications required for this role'),
    sa.Column('password_change_frequency_days', sa.Integer(), nullable=True, comment='How often users with this role must change their password'),
    sa.Column('expires_at', sa.DateTime(), nullable=True, comment='The expiration time of the role'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    with op.batch_alter_table('roles', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_roles_parent_id'), ['parent_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], name='fk_teammetadata_teams_id'),
    sa.PrimaryKeyConstraint('id'),
    comment='Key-value pairs storing custom metadata for teams'
    )
    op.create_table('user_credentials',
    sa.Column('password_hash', sa.String(), nullable=True, comment="Bcrypt hash of the user's password"),
    sa.Column('password_salt', sa.String(), nullable=True, comment='Salt used for password hashing'),
    sa.Column('password_changed', sa.DateTime(), nullable=True, comment='When this password was changed; null indicates current password'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('deleted_by_user_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_usercredential_users_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('deleted_by_user_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_usermetadata_users_id'),
    sa.PrimaryKeyConstraint('id'),
    comment='Key-value pairs storing custom metadata for users'
    )
    op.create_table('user_recovery_questions',
    sa.Column('question', sa.String(), nullable=False, comment='Security question text'),
    sa.Column('answer', sa.String(), nullable=False, comment='Hashed answer to the security question'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('deleted_by_user_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_userrecoveryquestion_users_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('resource_type', sa.String(), nullable=False, comment='Type of resource being granted permissions for'),
    sa.Column('resource_id', sa.String(), nullable=False, comment='ID of the specific resource'),
    sa.Column('expires_at', sa.DateTime(), nullable=True, comment='The expiration time of the permission'),
    sa.Column('can_view', sa.Boolean(), nullable=True, comment='Permission to view the resource'),
    sa.Column('can_execute', sa.Boolean(), nullable=True, comment='Permission to execute or run the resource'),
    sa.Column('can_copy', sa.Boolean(), nullable=True, comment='Permission to duplicate the resource'),
    sa.Column('can_edit', sa.Boolean(), nullable=True, comment='Permission to modify the resource'),
    sa.Column('can_delete', sa.Boolean(), nullable=True, comment='Permission to delete the resource'),
    sa.Column('can_share', sa.Boolean(), nullable=True, comment='Permission to share the resource with others'),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('created_by_user_id', sa.String(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], name='fk_permission_roles_id'),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], name='fk_permission_teams_id'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_permission_users_id'),
    sa.PrimaryKeyConstraint('id'),
    comment='Fine-grained permissions for specific resources and actions'
    )
    op.create_table('provider_extension_abilities',
    ...
    sa.ForeignKeyConstraint(['ability_id'], ['abilities.id'], name='fk_providerextensionability_abilities_id'),
    sa.ForeignKeyConstraint(['provider_extension_id'], ['provider_extensions.id'], name='fk_providerextensionability_provider_extensions_id'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('role_id', sa.String(), nullable=True),
    sa.Column('team_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], name='fk_ratelimitpolicy_roles_id'),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], name='fk_ratelimitpolicy_teams_id'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_ratelimitpolicy_users_id'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('invitation_invitees',
    sa.Column('email', sa.String(), nullable=False, comment='Email address of the invitee'),
