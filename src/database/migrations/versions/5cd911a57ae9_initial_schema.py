...
Revision ID: 5cd911a57ae9
Revises:
Create Date: 2025-04-29 17:55:32.855971
...
def upgrade() -> None:
    ...
    op.drop_table("alembic_version_ai_prompts")
    op.drop_table("alembic_version_ai_conversations")
    op.drop_table("alembic_version_ai_agents")
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table(
        "alembic_version_ai_agents",
        sa.Column("version_num", sa.VARCHAR(length=32), nullable=False),
        sa.PrimaryKeyConstraint("version_num", name="alembic_version_ai_agents_pkc"),
    )
    op.create_table(
        "alembic_version_ai_conversations",
        sa.Column("version_num", sa.VARCHAR(length=32), nullable=False),
        sa.PrimaryKeyConstraint(
            "version_num", name="alembic_version_ai_conversations_pkc"
        ),
    )
    op.create_table(
        "alembic_version_ai_prompts",
        sa.Column("version_num", sa.VARCHAR(length=32), nullable=False),
        sa.PrimaryKeyConstraint("version_num", name="alembic_version_ai_prompts_pkc"),
    )
