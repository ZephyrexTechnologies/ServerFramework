...
#     print(f"Entity: {entity} (Domain: {domain})")
...
#         print(f"Tablename: {cls.__tablename__}")
...
#                 print(f"  - {name}: Relates to {target_name} via {rel.back_populates or 'N/A'}")
...
#     print(f"Project tablename: {Project.__tablename__}")
#     print(f"Conversation tablename: {Conversation.__tablename__}")
#     print(f"Message tablename: {Message.__tablename__}")
#     print(f"CustomEntityWithLongName tablename: {CustomEntityWithLongName.__tablename__}")
...
#         print(f"  - {endpoint}: {docs['summary']}")
#         print(f"    {docs['description']}")
#         print()# Example: Using localization in database models with relationships
...
class Localization:
        ...
        for filename in os.listdir(base_dir):
            if filename.startswith("docs.") and filename.endswith(".json"):
                ...
                try:
                    ...
                    print(f"Error loading locale file {filename}: {e}")
    ...
    def get_relationship_backref_name(
        ...
        if (
            ...
            # Get the plural form of the source entity, convert to lowercase, and make it a valid Python identifier
            source_plural = self.get_entity_plural(source_domain, source_entity)
            return source_plural.lower().replace(" ", "_")

        # Default: just append 's' to the lowercase source entity name
        return f"{source_entity.lower()}s"
...
def update_entity_definition(
    ...
    try:
        ...
        print(f"Error updating entity definition: {e}")
        return False
...
if __name__ == "__main__":
    ...
    if args.command == "generate":
        ...
        if success:
            ...
            print("Failed to update entity definition")
    else:
        parser.print_help()
